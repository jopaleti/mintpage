									...
									<div className="flex-right">
										<div>
											...
											<p className="mt-4">
												...
												Titans, and became the new Greek deity, he felt a sense
												of power and content he had never felt before. However,
												after hundreds of years as the King of the Gods, he
												became bored and set about to instil something never
												seen before in history… a competition between the gods.
											</p>
										</div>
									</div>
								</div>
